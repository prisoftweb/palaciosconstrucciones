...
//           {/* <p className={`absolute ${font.titlespecial} bottom-0 top:1/5 lg:top-1/2`}>{'Reglamento interno'}</p> */}
...
//         </p>
//         <p className={`${font.heading4} ${util.u_margin_bottom_sm} mt-5`}>
//           La jornada laboral es de 6 días a la semana.
//         </p>
//         <p className={`${font.heading4} ${util.u_margin_bottom_sm} mt-5`}>
//           La jornada de trabajo es la siguiente para todo el personal de Palacios Construcciones.
//         </p>
...
//           </p>
//         <p className={`${font.heading4} ${util.u_margin_bottom_sm} mt-5`}>
//           Todos los trabajadores tendrán derecho a una hora de comida, la cual se tomará a partir 
//           de 4 horas después de su hora de entrada.
//         </p>
//         <p className={`${font.heading4} ${util.u_margin_bottom_sm} mt-5`}>
//           Los empleados deberán cumplir con el horario establecido. Cualquier cambio deberá 
//           ser autorizado y notificado por el Director General.
//         </p>
//         <p className={`${font.heading4} ${util.u_margin_bottom_sm} mt-5`}>
//           En caso de que el cliente de Palacios Construcciones asigne otro horario, 
//           se hará excepción para que los trabajadores puedan acoplarse a los horarios que establezcan.
//         </p>
//         <p className={`${font.heading4} ${util.u_margin_bottom_sm} mt-5`}>
//           Cuando la empresa requiera que el personal preste sus servicios después de su horario 
...
//         </p>
//         <p className={`${font.heading4} ${util.u_margin_bottom_sm} mt-5`}>
//           Las horas extras serán asignadas bajo previa autorización.
//         </p>
//         <p className={`${font.heading4} ${util.u_margin_bottom_sm} mt-5`}>
//           El control de asistencia de todos los trabajadores será mediante la aplicación de FISCOCLIC
//         </p>
//         <p className={`${font.heading4} ${util.u_margin_bottom_sm} mt-5`}>
//           El trabajador tiene responsabilidad de registrar sus entradas y salidas, sin excepción.
//         </p>
//         <p className={`${font.heading4} ${util.u_margin_bottom_sm} mt-5`}>
//           El trabajador tiene la obligación de presentarse en su área de trabajo con su 
//           indumentaria completa y equipado con la herramienta necesaria para desempeñar 
//           su trabajo correspondiente.
//         </p>
//         <p className={`${font.heading4} ${util.u_margin_bottom_sm} mt-5`}>
//           En caso de que el trabajador no se presente en su área de trabajo sin previo 
//           aviso se tomará como falta injustificada.
//         </p>
//         <p className={`${font.heading4} ${util.u_margin_bottom_sm} mt-5`}>
//           Si el trabajador necesita suspender sus labores durante su horario laboral, 
...
//         </p>
//         <p className={`${font.heading4} ${util.u_margin_bottom_sm} mt-5`}>
//           Los sueldos y salarios de cada trabajador serán asignados por el Gerente de 
//           la empresa de acuerdo al “tabulador de sueldos”.
//         </p>
//         <p className={`${font.heading4} ${util.u_margin_bottom_sm} mt-5`}>
//           El pago de sueldos y salarios será pagado mediante transferencia a la cuenta 
//           que el trabajador asigno previamente.
//         </p>
//         <p className={`${font.heading4} ${util.u_margin_bottom_sm} mt-5`}>
//           El trabajador tendrá la obligación de tramitar su cuenta para que le pueda generar 
//           su pago de nómina en tiempo y forma.
//         </p>
//         <p className={`${font.heading4} ${util.u_margin_bottom_sm} mt-5`}>
//           La cuenta (clave interbancaria) deberá ser personal.
//         </p>
//         <p className={`${font.heading4} ${util.u_margin_bottom_sm} mt-5`}>
//           La cuenta clave del trabajador deberá ser compartida al área correspondiente.
//         </p>
//         <p className={`${font.heading4} ${util.u_margin_bottom_sm} mt-5`}>
//           El pago se efectuará los días viernes.
//         </p>
//         <p className={`${font.heading4} ${util.u_margin_bottom_sm} mt-5`}>
//           En caso de que existan situaciones extraordinarias por parte de la empresa, 
//           el pago podrá efectuarse hasta el día sábado.
//         </p>
//         <p className={`${font.heading4} ${util.u_margin_bottom_sm} mt-5`}>
//           El pago comprenderá los días trabajados, séptimo día proporcional a días 
...
//         </p>
//         <p className={`${font.heading4} ${util.u_margin_bottom_sm} mt-5`}>
//           En caso de ser trabajador foráneo el pago también comprenderá viáticos.
//         </p>
//         <p className={`${font.heading4} ${util.u_margin_bottom_sm} mt-5`}>
//           Si el trabajador tiene derecho a vacaciones y son autorizadas, 
...
//         </p>
//         <p className={`${font.heading4} ${util.u_margin_bottom_sm} mt-5`}>
//           Los trabajadores tienen derecho a permiso en caso de emergencia familiar, 
...
//         </p>
//         <p className={`${font.heading4} ${util.u_margin_bottom_sm} mt-5`}>
//           Los permisos por enfermedad deberán justificarse con comprobante medico
//         </p>
//         <p className={`${font.heading4} ${util.u_margin_bottom_sm} mt-5`}>
//           Dichos permisos serán otorgados sin goce de sueldo y pagados acordes a la 
//           incapacidad otorgada mediante el IMSS. En caso de lo contrario el director 
//           será el encargado de autorizarlo.
//         </p>
//         <p className={`${font.heading4} ${util.u_margin_bottom_sm} mt-5`}>
//           Las condiciones de los permisos podrán ser consultadas con el área de Recursos Humanos.
//         </p>
//       </section>
...
//         </p>
//         <p className={`${font.heading4} ${util.u_margin_bottom_sm} mt-5`}>
//           Todos los trabajadores tendrán derecho a gozar de un día de descanso 
//           a la semana y días festivos establecidos por la ley.
//         </p>
//         <p className={`${font.heading4} ${util.u_margin_bottom_sm} mt-5`}>
//           En caso de que se requiera de los servicios de los trabajadores en días 
...
//         </p>
//         <p className={`${font.heading4} ${util.u_margin_bottom_sm} mt-5`}>
//           Los trabajadores tienen derecho a vacaciones anuales conforme 
//           a la antigüedad y lo establecido por la ley.
//         </p>
//         <p className={`${font.heading4} ${util.u_margin_bottom_sm} mt-5`}>
//           La programación de vacaciones deberá ser acorde a la política establecida dentro de la empresa.
//         </p>
//         <p className={`${font.heading4} ${util.u_margin_bottom_sm} mt-5`}>
//           Todos los trabajadores tienen derecho a recibir un trato respetuoso y 
//           digno por parte de sus superiores y compañeros.
//         </p>
//         <p className={`${font.heading4} ${util.u_margin_bottom_sm} mt-5`}>
//           Derecho a recibir remuneración y beneficios acordados desde su 
//           ingreso de manera puntual y completa.
//         </p>
//         <p className={`${font.heading4} ${util.u_margin_bottom_sm} mt-5`}>
//           Todos los trabajadores tendrán derecho a participar en las 
//           prestaciones y beneficios ofrecidos por la empresa.
//         </p>
//         <p className={`${font.heading4} ${util.u_margin_bottom_sm} mt-5`}>
//           Derecho a un ambiente laboral seguro, donde se cumplan las normativas de seguridad e higiene.
//         </p>
//         <p className={`${font.heading4} ${util.u_margin_bottom_sm} mt-5`}>
...
//         </p>
//         <p className={`${font.heading4} ${util.u_margin_bottom_sm} mt-5`}>
//           Los trabajadores deben presentarse puntualmente a su jornada laboral.
//         </p>
//         <p className={`${font.heading4} ${util.u_margin_bottom_sm} mt-5`}>
//           Cumplir con sus deberes laborales de manera eficiente.
//         </p>
//         <p className={`${font.heading4} ${util.u_margin_bottom_sm} mt-5`}>
...
//         </p>
//         <p className={`${font.heading4} ${util.u_margin_bottom_sm} mt-5`}>
//           Cumplir con las normas de seguridad e higiene en el trabajo y 
//           asistir a las capacitaciones que se les impongan.
//         </p>
//         <p className={`${font.heading4} ${util.u_margin_bottom_sm} mt-5`}>
//           Cuidar y mantener en buen estado los equipos, herramientas y demás bienes de la empresa.
//         </p>
//         <p className={`${font.heading4} ${util.u_margin_bottom_sm} mt-5`}>
//           Cumplir con los horarios establecidos y justificar cualquier ausencia o retraso.
//         </p>
//         <p className={`${font.heading4} ${util.u_margin_bottom_sm} mt-5`}>
//           Informar a la empresa sobre cualquier cambio en su situación que pueda 
//           afectar su relación laboral.
//         </p>
//         <p className={`${font.heading4} ${util.u_margin_bottom_sm} mt-5`}>
//           Informar de inmediato a sus superiores sobre cualquier situación 
...
//         </p>
//         <p className={`${font.heading4} ${util.u_margin_bottom_sm} mt-5`}>
//           Los trabajadores deben mantener una conducta respetuosa en todo momento.
//         </p>
//         <p className={`${font.heading4} ${util.u_margin_bottom_sm} mt-5`}>
//           No se permite el uso de leguaje ofensivo, discriminatorio o abusivo.
//         </p>
//         <p className={`${font.heading4} ${util.u_margin_bottom_sm} mt-5`}>
//           Esta prohibido realizar cualquier actividad ilícita o inapropiada en el lugar de trabajo.
//         </p>
//       </section>
...
import ValidationUser from "@/components/regulation/ValidationUser";
